"""
更改backbone：将cspdarknet中的残差模块变更为repvggBlockg
更改head为DFL head
"""
...
data_root = '/home/chenzhen/code/detection/datasets/dt_hangzhou/coco_dt_with_date_captured2/'
...
pre_transform = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_occs=True)
]
...
train_pipeline_stage3 = [
    *pre_transform,
    dict(type='mmdet.Resize', scale=(800, 450), keep_ratio=True),
    # dict(
    #     type='mmdet.Pad',
    #     pad_to_square=True,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=train_pipeline_stage3))
