"""
更改backbone：将cspdarknet中的残差模块变更为repvggBlock
"""

class_name = ('Car', 'Bus', 'Cycling', 'Pedestrian', 'driverless_Car',
...
custom_hooks = [
    # dict(
    #     type='YOLOXDataSwitchHook',
    #     change_epochs=transform_change_epochs,
